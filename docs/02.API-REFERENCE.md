...
```c
void
jerry_module_set_import_callback (jerry_module_resolve_callback_t callback_p,
                                  void *user_p)
```

- `callback_p` - a [jerry_module_resolve_callback_t](#jerry_module_resolve_callback_t) callback which handles `import()` calls
- `user_p` - user pointer passed to the callback
                 ...
                 void *user_p) /**< user data */
{
  ...
  /* This Promise should be fulfilled with the namespace object of the module
   * when the module is evaluated. If the module cannot be loaded, linked, or
   * evaluated, this Promise should be rejected. */
...
main (void)
{
  ...
  jerry_module_set_import_callback (resolve_dynamic, NULL);

  const jerry_char_t script[] = "import('b.mjs')";
  const jerry_char_t file[] = "a.mjs";
