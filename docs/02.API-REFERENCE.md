...
It is recommended to set this function before the first external string is created.

*Note*: when the callback is NULL, no function is called when an external string is freed.
